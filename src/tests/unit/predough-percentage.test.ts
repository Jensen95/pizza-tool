...
expect(Math.abs(originalResult.totalFlourWeight - adjustedResult.totalFlourWeight)).toBeLessThan(
5
);
...
const adjustedBigaFlour = adjustedResult.scaledIngredients.find(
(i) => i.id === 'biga-flour'
);
const adjustedMainFlour = adjustedResult.scaledIngredients.find(
(i) => i.id === 'main-flour'
);
...
yieldPizzas: 4,
ingredients: [
{ id: 'poolish-flour', name: 'Flour', nameDa: 'Mel', percentage: 100, type: 'flour', stage: 'poolish' },
{ id: 'poolish-water', name: 'Water', nameDa: 'Vand', percentage: 50, type: 'water', stage: 'poolish' },
{ id: 'main-water', name: 'Water', nameDa: 'Vand', percentage: 15, type: 'water', stage: 'main' },
...
...recipe100,
ingredients: [
{ id: 'poolish-flour', name: 'Flour', nameDa: 'Mel', percentage: 30, type: 'flour', stage: 'poolish' },
{ id: 'poolish-water', name: 'Water', nameDa: 'Vand', percentage: 15, type: 'water', stage: 'poolish' },
{ id: 'main-flour', name: 'Flour', nameDa: 'Mel', percentage: 70, type: 'flour', stage: 'main' },
{ id: 'main-water', name: 'Water', nameDa: 'Vand', percentage: 50, type: 'water', stage: 'main' },
{ id: 'salt', name: 'Salt', nameDa: 'Salt', percentage: 2.5, type: 'salt', stage: 'main' }
]
};
...
ingredients: [
// Autolyse stage
{ id: 'autolyse-flour', name: 'Flour', nameDa: 'Mel', percentage: 100, type: 'flour', stage: 'autolyse' },
{ id: 'autolyse-water', name: 'Water', nameDa: 'Vand', percentage: 60, type: 'water', stage: 'autolyse' },
// Main stage
{ id: 'main-water', name: 'Water', nameDa: 'Vand', percentage: 10, type: 'water', stage: 'main' },
{ id: 'main-salt', name: 'Salt', nameDa: 'Salt', percentage: 2.5, type: 'salt', stage: 'main' },
{ id: 'main-yeast', name: 'Yeast', nameDa: 'Gær', percentage: 0.2, type: 'yeast', stage: 'main' }
],
schedule: { stages: [], totalTime: 0 }
};
